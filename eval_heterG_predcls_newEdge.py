...
from Heter_ssg_eval_tool import Object_Accuracy, Object_Recall, Heter_Predicate_Accuracy,Heter_Relation_Recall
from Heter_ssg_eval_tool_type import Heter_Predicate_Recall,Type_Relation_Recall,Set_Relation_Recall
...
def main(args):
    ...
    experiment_dir = experiment_dir.joinpath('Eval_PredCls')
    experiment_dir.mkdir(exist_ok=True)
    ...
    address_network = os.path.join(PROJECT_DIR, 'log/model_PredCls/2023-07-09_11-55')  # 2022-10-24_10-41
    ...
    #test_rel_recall_type = Type_Relation_Recall(len(testDataLoader), need_softmax=False)
    test_rel_recall_set_s = Type_Relation_Recall(len(testDataLoader), need_softmax=False, set_type="support")
    test_rel_recall_set_p = Type_Relation_Recall(len(testDataLoader), need_softmax=False, set_type="proximity")
    test_rel_recall_set_c = Type_Relation_Recall(len(testDataLoader), need_softmax=False, set_type="comparative")
    '''
    test_rel_recall_set = Set_Relation_Recall(len(testDataLoader), need_softmax=False, set_type="tail")
    ...
    with torch.no_grad():
        ...
        for i, data in test_bar:
            ...
            node_output, multi_logits, multi_edge_output = network(obj_codes, pred_codes, Edge_weights,
                                                                   pc_geom_info )
            ...
            '''test_rel_recall_set_s.calculate_separa_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)
            test_rel_recall_set_s.calculate_separa_ngc_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)
            test_rel_recall_set_s.calculate_separa_mean_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)

            test_rel_recall_set_p.calculate_separa_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)
            test_rel_recall_set_p.calculate_separa_ngc_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)
            test_rel_recall_set_p.calculate_separa_mean_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)

            test_rel_recall_set_c.calculate_separa_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)
            test_rel_recall_set_c.calculate_separa_ngc_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)
            test_rel_recall_set_c.calculate_separa_mean_recall(node_output_eval, heter_edge_output_eval, gt_obj, gt_rel)'''
